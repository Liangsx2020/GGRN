...
| 界面 PINN (热方程) | `oh2025physics` | Para 3：轴增广 PINN 处理非理想接触 |
...
| PINO (semi-supervised) | `li2024physics` | Para 3：data+physics 训练范式 |
